...
### **Каждая задача в отдельном модуле, интегрируется на страницу в свой div елемент.**
### **Добавил события клика на гоблина, заглавные ячейки и на кнопки.**

## Ссылкка на [github-pages](https://rt-vinsent.github.io/ahj-homeworks-2/)

[![Build status](https://ci.appveyor.com/api/projects/status/0oxvts9sm5a47f67?svg=true)](https://ci.appveyor.com/project/RT-Vinsent/ahj-homeworks-2)
...
![](https://github.com/RT-Vinsent/ahj-homeworks/raw/simplification/dom/pic/GracefulMiniatureBustard-small.gif)
...
![](https://github.com/RT-Vinsent/ahj-homeworks/raw/simplification/dom/pic/goblin.png)
